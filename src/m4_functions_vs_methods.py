...
def try_methods():
    Daishen = rg.SimpleTurtle()
    Daishen.pen = rg.Pen( 'brown', 5)
    Daishen.forward(150)
    Daishen.left(90)
    Daishen.forward(50)
    Daishen.backward(100)
...
def try_methods_and_functions():
    HDD = rg.SimpleTurtle()
    HDD.pen = rg.Pen("blue", 5)
    HDD.backward(150)
    HDD.speed = 1
    draw_many_squares(HDD, 2, 100, 30)
    HDD.speed = 5
    HDD.pen = rg.Pen("red", 5)
    draw_many_squares(HDD, 10, 50, 15)
    HDD.speed = 100
    HDD.oen = rg.Pen("red", 35)
    draw_many_squares(HDD, 8, 300, 60)
    HDD.pen = rg.Pen("black", 3)
    HDD.backward(200)
    HDD.draw_circle(30)
    HDD.drw_square(50)
    """
