...
def main():
    ...
    """
    print('The following line will be the function to value the hypotenuse of a right triangle')
    print(Daishen ( 3.45 , 4.25))
###############################################################################
...
import rosegraphics as rg
turtle = rg.SimpleTurtle()
turtle.pen = rg.Pen('green' ,GIVEN1)
another_turtle = rg.SimpleTurtle()
another_turtle.pen = rg.Pen( GIVEN2 , 5)
